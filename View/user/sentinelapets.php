...
$sql = "SELECT * FROM anuncios WHERE status LIKE '%naoverificado%'";
...
<body>
    ...
    <main role="main" class="flex-grow container max-w-7xl mx-auto px-2 py-4 sm:px-6 sm:py-6 lg:px-8 lg:py-8">
        <h1 class="text-center" style="font-size: 20px;font-family: 'Open Sans', sans-serif;">Pets para analisar</h1>
        <br>
        <?php
        if (mysqli_num_rows($result) < 1) {
        ?>
            <p align="center">Desculpe mais você não possui nenhum animal para analisar</p>
            <br>
        <?php
        }
        ?>
                ...
                <table>
                    <th>
                        <div id="imagens" class="flex-1 bg-white rounded-lg shadow-md overflow-hidden">
                            <a class="block relative" href="../../View/user/sentinelapet.php?id=<?php echo $id; ?>">
                            ...
                            <div class="p-3 sm:p-6">
                                <div>
                                    <a class="font-bold hover:text-secondary" href="../../View/user/sentinelapet.php?id=<?php echo $id; ?>"><?php echo $nome; ?></a>
                                </div>
