...
if (isset($_POST['update'])) {
    ...
    $sqlInsert = "UPDATE anuncios SET nome='$nome',descricao='$descricao',parentesco='$parentesco',idade='$idade',vacinacao='$vacinacao',sexo='$sexo',saude='$saude',endereco='$endereco',coordenada='$coordenada',status='$status',tipo='$tipo' WHERE id=$id";
